...
public class AcidicVenomEffect extends MagicMobEffect implements ISyncedMobEffect {
    public static final float DAMAGE_PER_LEVEL = .5f;

    public AcidicVenomEffect(MobEffectCategory pCategory, int pColor) {
    ...
    public void clientTick(LivingEntity livingEntity, MobEffectInstance instance) {
        ParticleOptions particle = ModParticleHelper.ACIDIC_VENOM_BUBBLE;
