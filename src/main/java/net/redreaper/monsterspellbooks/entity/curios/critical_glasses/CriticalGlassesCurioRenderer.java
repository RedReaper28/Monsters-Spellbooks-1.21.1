...
import net.redreaper.monsterspellbooks.entity.curios.reaper_lantern.ReaperLanternCurioItemRenderer;
import top.theillusivec4.curios.api.SlotContext;
import top.theillusivec4.curios.api.client.ICurioRenderer;

@OnlyIn(Dist.CLIENT)
public class CriticalGlassesCurioRenderer implements ICurioRenderer {
    private final CriticalGlassesCurioItemRenderer curioRenderer = new CriticalGlassesCurioItemRenderer();
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        ResourceLocation textureLocation = CriticalGlassesCurioItemRenderer.TEX;
