...
import net.redreaper.monsterspellbooks.entity.curios.critical_glasses.CriticalGlassesCurioItemRenderer;
import top.theillusivec4.curios.api.SlotContext;
import top.theillusivec4.curios.api.client.ICurioRenderer;

@OnlyIn(Dist.CLIENT)
public class IgnitionGlovesCurioRenderer implements ICurioRenderer {
    private final IgnitionGlovesItemRenderer curioRenderer = new IgnitionGlovesItemRenderer();
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        ResourceLocation textureLocation = IgnitionGlovesItemRenderer.TEX;
