...
@OnlyIn(Dist.CLIENT)
public class ObsidianMedalCurioRenderer implements ICurioRenderer {
    private final ObsidianMedalCurioItemRenderer curioRenderer = new ObsidianMedalCurioItemRenderer();
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        ResourceLocation textureLocation = ObsidianMedalCurioItemRenderer.TEX;
