...
@OnlyIn(Dist.CLIENT)
public class ThunderingQuiverCurioRenderer implements ICurioRenderer {
    private final ThunderingQuiverCurioItemRenderer curioRenderer = new ThunderingQuiverCurioItemRenderer();
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        ResourceLocation textureLocation = ThunderingQuiverCurioItemRenderer.TEX;
