...
public class DeathKnightEntity extends UniqueAbstractSpellCastingMob implements IMagicSummon, GeoAnimatable, IAnimatedAttacker {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    protected UUID summonerUUID;

    public DeathKnightEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
    ...
    public DeathKnightEntity(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_DEATH_KNIGHT.get(), level);
    }
    ...
    public void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new GenericAnimatedWarlockAttackGoal<>(this, 1.5F, 5, 10)
                ...
                .setSingleUseSpell(ModSpellRegistry.VILE_SLASH.get(), 10, 15, 1, 3)
    ...
    private final AnimationController<DeathKnightEntity> castingAnimationController = new AnimationController<>(this, "casting_controller", 0, this::castingPredicate);
    ...
    private PlayState attackPredicate(AnimationState<DeathKnightEntity> event)
    {
    ...
    private PlayState castingPredicate(AnimationState<DeathKnightEntity> event)
    {
        if (isCasting() && this.animationToPlay == null)
        {
            event.getController().setAnimation(RawAnimation.begin().thenPlay("slash_cast"));
            return PlayState.CONTINUE;
        }
