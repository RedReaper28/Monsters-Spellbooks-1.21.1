...
public class DwarvenSphereEntity extends Monster implements GeoEntity {
    ...
    public void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, .8F, true));
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.add(Attributes.MAX_HEALTH, (double)30.0F);
        builder = builder.add(Attributes.ARMOR, (double)5.0F);
        builder = builder.add(Attributes.ATTACK_DAMAGE, (double)6.0F);
        builder = builder.add(Attributes.ENTITY_INTERACTION_RANGE, (double)1.5F);
    ...
    static {
        SHOOT = SynchedEntityData.defineId(DwarvenSphereEntity.class, EntityDataSerializers.BOOLEAN);
        ANIMATION = SynchedEntityData.defineId(DwarvenSphereEntity.class, EntityDataSerializers.STRING);
        TEXTURE = SynchedEntityData.defineId(DwarvenSphereEntity.class, EntityDataSerializers.STRING);
    }
}
