...
public class RedstoneElementalEntity extends UniqueAbstractSpellCastingMob implements GeoAnimatable, IMagicEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public RedstoneElementalEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
    ...
    public RedstoneElementalEntity(Level level, LivingEntity owner) {
        this(ModEntities.REDSTONE_ELEMENTAL.get(), level);
    }
    ...
    public void registerGoals() {
        this.goalSelector.addGoal(3, new WizardAttackGoal(this, 1.25f, 30, 55)
                .setSpells(
                        List.of(ModSpellRegistry.REDSTONE_CHAIN.get()),
                        List.of(),
                        List.of(),
                        List.of()
