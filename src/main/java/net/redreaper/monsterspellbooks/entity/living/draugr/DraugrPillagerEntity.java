...
public class DraugrPillagerEntity extends DraugrIllagerEntity implements RangedAttackMob,Enemy, IAnimatedAttacker {
    ...
    public DraugrPillagerEntity(EntityType<? extends DraugrIllagerEntity> pEntityType, Level pLevel) {
