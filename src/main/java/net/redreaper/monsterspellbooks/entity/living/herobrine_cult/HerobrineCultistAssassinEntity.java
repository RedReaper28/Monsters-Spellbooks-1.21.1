...
public class HerobrineCultistAssassinEntity extends HerobrineCultistEntity implements IAnimatedAttacker {
    public HerobrineCultistAssassinEntity(EntityType<? extends AbstractSpellCastingMob> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new GenericAnimatedWarlockAttackGoal<>(this, 1.25f, 50, 75)
                ...
                .setSpells(
                        List.of(SpellRegistry.BLOOD_SLASH_SPELL.get(), ModSpellRegistry.SPIRIT_STRIKE.get()),
                        List.of(),
    ...
    private final AnimationController<HerobrineCultistAssassinEntity> meleeController = new AnimationController<>(this, "keeper_animations", 0, this::predicate);
    ...
    private PlayState predicate(AnimationState<HerobrineCultistAssassinEntity> animationEvent) {
