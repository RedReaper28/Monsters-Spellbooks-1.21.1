...
public class DwarvenSwarmDroneEntity extends UniqueAbstractSpellCastingMob implements IMagicSummon, GeoAnimatable, IMagicEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public DwarvenSwarmDroneEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
    ...
    public DwarvenSwarmDroneEntity(Level level, LivingEntity owner) {
        this(ModEntities.DWARVEN_SWARM_DRONE.get(), level);
    }
    ...
    public boolean doHurtTarget(Entity entity) {
        return Utils.doMeleeAttack(this, entity, ModSpellRegistry.SUMMON_DWARVEN_DRONES.get().getDamageSource(this, getSummoner()));
    }
