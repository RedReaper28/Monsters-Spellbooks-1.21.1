...
public class IceSerpeantEntity extends UniqueAbstractSpellCastingMob implements IMagicSummon, GeoAnimatable, IMagicEntity {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public IceSerpeantEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
    ...
    public IceSerpeantEntity(Level level, LivingEntity owner) {
        this(ModEntities.ICE_SERPEANT.get(), level);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new WizardAttackGoal(this, 1.25f, 30, 55)
                .setSpells(
                        // Attack
                        List.of(
                                ModSpellRegistry.FROST_BREATH.get(), SpellRegistry.CONE_OF_COLD_SPELL.get()
                        ),
                        // Defense
                        List.of(
                        ),
    ...
    public void onUnSummon() {
        ...
        {
            MagicManager.spawnParticles(this.level(), ParticleHelper.SNOW_DUST,
                    getX(), getY(), getZ(),
