...
public class OrbitalSnowballEntity extends UniqueAbstractSpellCastingMob implements IMagicSummon, GeoAnimatable, IMagicEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public OrbitalSnowballEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.noPhysics = true;
        xpReward = 0;
    }

    public OrbitalSnowballEntity(Level level, LivingEntity owner) {
        this(ModEntities.ORBITAL_SNOWBALL.get(), level);
    }
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(3, new WizardAttackGoal(this, 1.25f, 50, 65)
                .setSpells(
                        // Attack
                        List.of(
                                ModSpellRegistry.FROSTED_SNOWBOLT.get()),
                        // Defense
                        List.of(),
                        // Movement
                        List.of(),
