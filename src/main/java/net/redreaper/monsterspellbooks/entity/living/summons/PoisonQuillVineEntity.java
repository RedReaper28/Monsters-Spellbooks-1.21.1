...
public class PoisonQuillVineEntity extends UniqueAbstractSpellCastingMob implements IMagicSummon, GeoAnimatable, IMagicEntity {
    ...
    @Override public boolean dampensVibrations() {
        return true;
    }
    ...
    @Override public boolean hurt(DamageSource pSource, float pAmount) {return !this.shouldIgnoreDamage(pSource) && super.hurt(pSource, pAmount);}
