...
public class RancorPhantomEntity extends PathfinderMob implements GeoEntity {
    @Nullable
    ...
    public RancorPhantomEntity(EntityType<? extends RancorPhantomEntity> entityType, Level level) {
        super(entityType, level);
        this.setNoGravity(true);
    }

    public RancorPhantomEntity(Level levelIn, LivingEntity owner, float damageAmount) {
        this(ModEntities.RANCOR_PHANTOM.get(), levelIn);
