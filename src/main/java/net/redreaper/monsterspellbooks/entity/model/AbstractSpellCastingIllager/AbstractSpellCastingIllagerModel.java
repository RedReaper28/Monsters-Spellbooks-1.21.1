...
public abstract class AbstractSpellCastingIllagerModel extends DefaultedEntityGeoModel<AbstractSpellCastingIllager> {

    public AbstractSpellCastingIllagerModel(/*ResourceLocation assetSubpath*/) {
    ...
    public ResourceLocation getModelResource(AbstractSpellCastingIllager object) {
        return AbstractSpellCastingIllager.modelResource;
    }

    @Override
    public abstract ResourceLocation getTextureResource(AbstractSpellCastingIllager mob);

    @Override
    public ResourceLocation getAnimationResource(AbstractSpellCastingIllager animatable) {
        return AbstractSpellCastingIllager.animationInstantCast;
    }

    @Override
    public void handleAnimations(AbstractSpellCastingIllager entity, long instanceId, AnimationState<AbstractSpellCastingIllager> animationState, float partialTick) {
    ...
    @Override
    public void setCustomAnimations(AbstractSpellCastingIllager entity, long instanceId, AnimationState<AbstractSpellCastingIllager> animationState) {
     ...
     */
    protected Vector2f getLimbSwing(AbstractSpellCastingIllager entity, WalkAnimationState walkAnimationState, float partialTick) {
