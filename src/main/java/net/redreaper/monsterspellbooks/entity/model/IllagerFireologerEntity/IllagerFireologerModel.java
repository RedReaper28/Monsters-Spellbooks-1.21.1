...
public class IllagerFireologerModel extends AbstractSpellCastingIllagerModel {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MonstersSpellbooks.MOD_ID, "textures/entity/illager_fireologer.png");
