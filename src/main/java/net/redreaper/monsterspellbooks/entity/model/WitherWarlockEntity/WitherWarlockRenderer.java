...
public class WitherWarlockRenderer extends AbstractSpellCastingMobRenderer {

    public WitherWarlockRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new WitherWarlockModel());
    }
