...
public class WitherWarriorRenderer extends AbstractSpellCastingMobRenderer {

    public WitherWarriorRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new WitherWarriorModel());
    }
