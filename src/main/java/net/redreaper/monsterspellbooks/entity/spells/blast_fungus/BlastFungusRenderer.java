...
public class BlastFungusRenderer extends EntityRenderer<BlastFungusProjectile> {
    private static ResourceLocation TEXTURE = MonstersSpellbooks.id("textures/entity/blast_fungus/blast_fungus.png");
    private static ResourceLocation SWIRL_TEXTURE = MonstersSpellbooks.id("textures/entity/blast_fungus/hair.png");


    private final ModelPart orb;
    private final ModelPart swirl;

    public BlastFungusRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(BlastFungusProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(BlastFungusProjectile entity) {
        return TEXTURE;
    }

    private ResourceLocation getSwirlTextureLocation(BlastFungusProjectile entity) {
