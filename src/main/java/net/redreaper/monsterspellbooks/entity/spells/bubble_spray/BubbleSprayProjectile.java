package net.redreaper.monsterspellbooks.entity.spells.bubble_spray;
...
public class BubbleSprayProjectile extends AbstractConeProjectile {
    ...
    public BubbleSprayProjectile(Level level, LivingEntity entity) {
        super(ModEntities.BUBBLE_SPRAY_PROJECTILE.get(), level, entity);
    }
    ...
    public void spawnParticles() {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            level().addParticle(random.nextFloat() < .25f ? ModParticleHelper.HYDRO_BUBBLE : ParticleTypes.FALLING_WATER, x + ox, y + oy, z + oz, result.x, result.y, result.z);
        }
    }
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        DamageSources.applyDamage(entity, damage, ModSpellRegistry.BUBBLE_SPRAY.get().getDamageSource(this, getOwner()));
    }
}
