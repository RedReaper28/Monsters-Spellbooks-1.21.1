...
public class EffervescenceBubbleRenderer extends EntityRenderer<EffervescenceBubbleProjectile> {
    private static ResourceLocation TEXTURE = MonstersSpellbooks.id("textures/entity/effervescence_bubble/swirl.png");
    private static ResourceLocation SWIRL_TEXTURE = MonstersSpellbooks.id("textures/entity/effervescence_bubble/effervescence_bubble.png");

    private final ModelPart orb;
    private final ModelPart swirl;

    public EffervescenceBubbleRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(EffervescenceBubbleProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
        ...
        poseStack.mulPose(Axis.YP.rotationDegrees(swirlY));
        poseStack.mulPose(Axis.ZP.rotationDegrees(swirlZ));
        consumer = bufferSource.getBuffer(RenderType.entityTranslucent(getSwirlTextureLocation(entity)));
    ...
    @Override
    public ResourceLocation getTextureLocation(EffervescenceBubbleProjectile entity) {
        return TEXTURE;
    }

    private ResourceLocation getSwirlTextureLocation(EffervescenceBubbleProjectile entity) {
        return SWIRL_TEXTURE;
    }
}
