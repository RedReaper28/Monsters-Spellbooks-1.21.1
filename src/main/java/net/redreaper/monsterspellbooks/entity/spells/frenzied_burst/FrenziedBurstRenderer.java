package net.redreaper.monsterspellbooks.entity.spells.frenzied_burst;
...
public class FrenziedBurstRenderer extends EntityRenderer<FrenziedBurstVisualEntity> {
    ...
    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MonstersSpellbooks.MOD_ID, "frenzied_burst_model"), "main");
    private static final ResourceLocation TEXTURE_CORE = MonstersSpellbooks.id("textures/entity/frenzied_burst/core.png");
    private static final ResourceLocation TEXTURE_OVERLAY = MonstersSpellbooks.id("textures/entity/frenzied_burst/overlay.png");

    private final ModelPart body;

    public FrenziedBurstRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public boolean shouldRender(FrenziedBurstVisualEntity pLivingEntity, Frustum pCamera, double pCamX, double pCamY, double pCamZ) {
        return true;
    }

    @Override
    public void render(FrenziedBurstVisualEntity entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
        float lifetime = FrenziedBurstVisualEntity.lifetime;
        float scalar = .25f;
    ...
    @Override
    public ResourceLocation getTextureLocation(FrenziedBurstVisualEntity entity) {
        return TEXTURE_CORE;
    }
}
