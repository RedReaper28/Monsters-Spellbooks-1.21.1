...
public class FrostedSnowboltRenderer extends EntityRenderer<AbstractMagicProjectile> {
    private final ModelPart orb;

    public FrostedSnowboltRenderer(EntityRendererProvider.Context context) {
        super(context);
