...
public class GuardiansNeutralizerRenderer extends EntityRenderer<GuardiansNeutralizerVisualEntity> {
    ...
    private static final ResourceLocation TEXTURE_CORE = MonstersSpellbooks.id("textures/entity/guardians_neutralizer/core.png");
    private static final ResourceLocation TEXTURE_OVERLAY = MonstersSpellbooks.id("textures/entity/guardians_neutralizer/overlay.png");

    private final ModelPart body;

    public GuardiansNeutralizerRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public boolean shouldRender(GuardiansNeutralizerVisualEntity pLivingEntity, Frustum pCamera, double pCamX, double pCamY, double pCamZ) {
        return true;
    }

    @Override
    public void render(GuardiansNeutralizerVisualEntity entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(GuardiansNeutralizerVisualEntity entity) {
        return TEXTURE_CORE;
    }
}
