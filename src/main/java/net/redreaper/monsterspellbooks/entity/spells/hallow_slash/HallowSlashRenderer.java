...
public class HallowSlashRenderer extends EntityRenderer<HallowSlashProjectile> {
    private static final ResourceLocation TEXTURE = MonstersSpellbooks.id("textures/entity/hallow_slash/hallow_slash_large.png");


    public HallowSlashRenderer(Context context) {
        super(context);
    }

    @Override
    public void render(HallowSlashProjectile pEntity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
    ...
    private void drawSlash(PoseStack.Pose pose, HallowSlashProjectile entity, MultiBufferSource bufferSource, float width)
    {
    ...
    public ResourceLocation getTextureLocation(HallowSlashProjectile entity) {
        return TEXTURE;
    }
