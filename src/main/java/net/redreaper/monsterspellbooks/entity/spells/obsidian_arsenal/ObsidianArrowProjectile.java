package net.redreaper.monsterspellbooks.entity.spells.obsidian_arsenal;
...
public class ObsidianArrowProjectile extends AbstractMagicProjectile {
    private static final EntityDataAccessor<Boolean> IN_GROUND = SynchedEntityData.defineId(ObsidianArrowProjectile.class, EntityDataSerializers.BOOLEAN);

    public ObsidianArrowProjectile(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public ObsidianArrowProjectile(Level levelIn, LivingEntity shooter) {
        this(ModEntities.OBSIDIAN_ARROW_PROJECTILE.get(), levelIn);
        setOwner(shooter);
    }
    ...
    public void impactParticles(double x, double y, double z) {
        MagicManager.spawnParticles(level(), ParticleHelper.ENDER_SPARKS, x, y, z, 15, .03, .03, .03, 0.2, true);
    }
