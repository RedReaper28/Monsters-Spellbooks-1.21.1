...
public class ObsidianArrowRenderer extends EntityRenderer<ObsidianArrowProjectile> {
    ...
    @Override
    public void render(ObsidianArrowProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(ObsidianArrowProjectile entity) {
