...
public class SmallObsidianArrowRenderer extends EntityRenderer<SmallObsidianArrowProjectile> {
    private static final ResourceLocation TEXTURE = MonstersSpellbooks.id("textures/entity/obsidian_arsenal/obsidian_arrow.png");

    public SmallObsidianArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(SmallObsidianArrowProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(SmallObsidianArrowProjectile entity) {
