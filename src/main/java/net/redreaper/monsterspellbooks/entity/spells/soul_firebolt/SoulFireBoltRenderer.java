...
public class SoulFireBoltRenderer extends EntityRenderer<Projectile> {

    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MonstersSpellbooks.MOD_ID, "soul_firebolt_model"), "main");
    private static ResourceLocation TEXTURE = MonstersSpellbooks.id("textures/entity/soul_fire_ball/soul_firebolt.png");

    private final ModelPart body;

    public SoulFireBoltRenderer(EntityRendererProvider.Context context) {
        super(context);
