...
public class SpaceBreaker extends AoeEntity {
    public SpaceBreaker(EntityType<? extends Projectile> pEntityType, Level pLevel) {
    ...
    {
        this(ModEntities.SPACE_BREAKER.get(), level);
    }
