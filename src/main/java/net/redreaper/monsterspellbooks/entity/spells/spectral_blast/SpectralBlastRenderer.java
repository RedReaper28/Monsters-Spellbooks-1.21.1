package net.redreaper.monsterspellbooks.entity.spells.spectral_blast;
...
public class SpectralBlastRenderer extends EntityRenderer<SpectralBlastVisualEntity> {
    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("monsterspellbooks", "spectral_blast_model"), "main");
    private static final ResourceLocation TEXTURE_CORE = MonstersSpellbooks.id("textures/entity/spectral_blast/core.png");
    private static final ResourceLocation TEXTURE_OVERLAY = MonstersSpellbooks.id("textures/entity/spectral_blast/overlay.png");

    private final ModelPart body;

    public SpectralBlastRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public boolean shouldRender(SpectralBlastVisualEntity pLivingEntity, Frustum pCamera, double pCamX, double pCamY, double pCamZ) {
        return true;
    }

    @Override
    public void render(SpectralBlastVisualEntity entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
        float lifetime = SpectralBlastVisualEntity.lifetime;
        float scalar = .25f;
    ...
    @Override
    public ResourceLocation getTextureLocation(SpectralBlastVisualEntity entity) {
        return TEXTURE_CORE;
    }
}
