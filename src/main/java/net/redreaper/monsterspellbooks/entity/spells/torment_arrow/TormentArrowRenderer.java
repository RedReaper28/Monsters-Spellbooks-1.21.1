...
public class TormentArrowRenderer extends EntityRenderer<TormentArrowProjectile> {
    private static final ResourceLocation TEXTURE = MonstersSpellbooks.id("textures/entity/torment_arrow/torment_arrow.png");

    public TormentArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(TormentArrowProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(TormentArrowProjectile entity) {
