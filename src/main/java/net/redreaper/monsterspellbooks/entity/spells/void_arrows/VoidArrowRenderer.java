...
public class VoidArrowRenderer extends EntityRenderer<VoidArrowProjectile> {
    private static final ResourceLocation TEXTURE = MonstersSpellbooks.id("textures/entity/void_arrows/void_arrow.png");
    ...
    @Override
    public void render(VoidArrowProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(VoidArrowProjectile entity) {
