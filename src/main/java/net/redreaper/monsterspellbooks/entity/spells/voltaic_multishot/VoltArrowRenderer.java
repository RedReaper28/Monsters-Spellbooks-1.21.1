...
public class VoltArrowRenderer extends EntityRenderer<AbstractMagicProjectile> {
    private static final ResourceLocation TEXTURE = MonstersSpellbooks.id("textures/entity/voltaic_multishot/volt_arrow_1.png");

    public VoltArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
