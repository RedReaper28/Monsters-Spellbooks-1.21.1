...
public class WitherNovaVisualEntity extends Entity implements IEntityWithComplexSpawn {
    public static final int lifetime = 15;

    public WitherNovaVisualEntity(EntityType<?> pEntityType, Level pLevel) {
