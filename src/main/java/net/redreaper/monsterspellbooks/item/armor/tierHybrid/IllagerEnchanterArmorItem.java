...
import net.redreaper.monsterspellbooks.entity.armor.IllagerEnchanterArmorModel;
import net.redreaper.monsterspellbooks.init.ModExtendedArmorMaterials;
import net.redreaper.monsterspellbooks.item.armor.custom.ModImbuableExtendedGeoArmorItem;
import software.bernie.geckolib.renderer.GeoArmorRenderer;

public class IllagerEnchanterArmorItem extends ModImbuableExtendedGeoArmorItem {
    ...
    private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(
            ...
            "textures/armor/illager_enchanter_armor_glow.png");
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        ...
        return new EmissiveGenericCustomArmorRenderer<>(new IllagerEnchanterArmorModel(), LAYER, GLOW_RENDER_TYPE);
    }
}