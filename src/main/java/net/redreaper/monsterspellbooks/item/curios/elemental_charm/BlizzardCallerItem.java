...
public class BlizzardCallerItem extends ImbueableCurioItem {
    public BlizzardCallerItem() {
        super(ItemPropertiesHelper.equipment().stacksTo(1).fireResistant().rarity(ASRarities.GLACIAL_RARITY_PROXY.getValue()), Curios.NECKLACE_SLOT);
    }
    ...
    public void initializeSpellContainer(ItemStack itemStack) {
        if (itemStack != null) {
            ...
            itemStack.set(ComponentRegistry.AFFINITY_COMPONENT, new AffinityData(Map.of(((AbstractSpell) ModSpellRegistry.FROST_COATING.get()).getSpellResource(), 2)));
        }
    }
