...
public class CrossNecklaceItem extends ImbueableCurioItem {
    ...
    public Multimap<Holder<Attribute>, AttributeModifier> getAttributeModifiers(SlotContext slotContext, ResourceLocation id, ItemStack stack) {
        ...
        attr.put(ASAttributeRegistry.EVASIVE, new AttributeModifier(id, 0.25, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
        return attr;
    }
    ...
    public void initializeSpellContainer(ItemStack itemStack) {
        if (itemStack != null) {
            ...
            itemStack.set(ComponentRegistry.AFFINITY_COMPONENT, new AffinityData(Map.of(((AbstractSpell) ModSpellRegistry.DIVINE_INTERVENTION.get()).getSpellResource(), 1)));
        }
    }
}