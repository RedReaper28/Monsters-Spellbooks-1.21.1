...
public class DeathsilverGreataxeItem extends ExtendedSwordItem {

    public DeathsilverGreataxeItem() {
        super(
                ModExtendedWeaponTiers.DEATHSILVER_GREATAXE,
                new Properties()
                        .stacksTo(1)
                        .rarity(ASRarities.GLACIAL_RARITY_PROXY.getValue())
                        .attributes(ExtendedSwordItem.createAttributes(ModExtendedWeaponTiers.DEATHSILVER_GREATAXE)
                        )
        );
    }
