...
public class ClawsOfCalamityItem extends MagicSwordItem implements GeoItem {
    ...
    public ClawsOfCalamityItem() {
        super(ModExtendedWeaponTiers.FORBIDDEN_TOOL,
                ItemPropertiesHelper.equipment(1).fireResistant().rarity(ASRarities.FORBIDDEN_RARITY_PROXY.getValue()).attributes(ExtendedSwordItem.createAttributes(ModExtendedWeaponTiers.FORBIDDEN_TOOL)),
    ...
    public void initializeSpellContainer(ItemStack itemStack) {
        ...
        AffinityData.setAffinityData(itemStack, ModSpellRegistry.ANCIENT_FLASH.get());
    }
