...
public class BrimstoneFireParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    public BrimstoneFireParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
    ...
    public void tick() {
        ...
        if (this.random.nextFloat() <= .25f) {
            this.level.addParticle(ModParticleTypes.BRIMSTONE_EMBERS_PARTICLE.get(), this.x, this.y, this.z, this.xd, this.yd, this.zd);
        }
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new BrimstoneFireParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
