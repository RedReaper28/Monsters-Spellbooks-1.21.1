...
public class EnderSmokeParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    public EnderSmokeParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new EnderSmokeParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}