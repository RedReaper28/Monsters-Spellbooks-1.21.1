...
public class HydroBubbleParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    public HydroBubbleParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
