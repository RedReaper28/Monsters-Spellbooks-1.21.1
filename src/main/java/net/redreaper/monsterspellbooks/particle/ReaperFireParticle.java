...
public class ReaperFireParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    public ReaperFireParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
    ...
    public void tick() {
        ...
        if (this.random.nextFloat() <= .25f) {
            this.level.addParticle(ModParticleTypes.REAPER_EMBERS_PARTICLE.get(), this.x, this.y, this.z, this.xd, this.yd, this.zd);
        }
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new ReaperFireParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
