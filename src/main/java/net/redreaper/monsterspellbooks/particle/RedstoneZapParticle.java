...
public class RedstoneZapParticle extends TextureSheetParticle {
    ...
    RedstoneZapParticle(ClientLevel pLevel, double pX, double pY, double pZ, double xd, double yd, double zd, RedstoneZapParticleOptions options) {
...
//            vector3f.transform(quaternion);
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider implements ParticleProvider<RedstoneZapParticleOptions> {
        ...
        public Particle createParticle(@NotNull RedstoneZapParticleOptions options, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            var particle = new RedstoneZapParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, options);
