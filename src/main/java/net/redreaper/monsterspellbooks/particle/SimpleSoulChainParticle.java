...
public class SimpleSoulChainParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    public SimpleSoulChainParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
