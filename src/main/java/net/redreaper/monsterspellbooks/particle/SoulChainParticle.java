...
public class SoulChainParticle extends TextureSheetParticle {
    ...
    SoulChainParticle(ClientLevel pLevel, double pX, double pY, double pZ, double xd, double yd, double zd, SoulChainParticleOptions options) {
...
//            vector3f.transform(quaternion);
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider implements ParticleProvider<SoulChainParticleOptions> {
        ...
        public Particle createParticle(@NotNull SoulChainParticleOptions options, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            var particle = new SoulChainParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, options);
