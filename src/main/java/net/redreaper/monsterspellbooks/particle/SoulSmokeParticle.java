...
public class SoulSmokeParticle extends TextureSheetParticle {
    ...
    public SoulSmokeParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new SoulSmokeParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}