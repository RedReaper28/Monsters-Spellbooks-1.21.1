...
public class SpiritStrikeParticle extends TextureSheetParticle {
    private final SpriteSet sprites;
    private final Vec3 forward;
    private final boolean mirror, vertical;
    private final Vector3f[] localVertices;

    SpiritStrikeParticle(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double xd, double yd, double zd, SpiritStrikeParticleOptions options) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider implements ParticleProvider<SpiritStrikeParticleOptions> {
        ...
        public Particle createParticle(@NotNull SpiritStrikeParticleOptions options, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            SpiritStrikeParticle shriekparticle = new SpiritStrikeParticle(pLevel, pX, pY, pZ, sprite, pXSpeed, pYSpeed, pZSpeed, options);
