...
public class RedstoneChainSpell extends AbstractSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(MonstersSpellbooks.MOD_ID, "redstone_chain");
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        if (playerMagicData.getAdditionalCastData() instanceof TargetEntityCastData targetData) {
            ...
            if (targetEntity != null) {
                RedstoneExplosionEntity chainLightning = new RedstoneExplosionEntity(world, entity, targetEntity);
    ...
    public float getRange(int spellLevel, LivingEntity caster) {
        return 5f + getSpellPower(spellLevel, caster) * .5f;
    }
}
