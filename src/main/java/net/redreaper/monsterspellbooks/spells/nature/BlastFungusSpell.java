...
public class BlastFungusSpell extends AbstractSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(MonstersSpellbooks.MOD_ID, "blast_fungus");
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        BlastFungusProjectile fireball = new BlastFungusProjectile(world, entity);
    ...
    public float getDamage(int spellLevel, LivingEntity caster) {
        return 7 + 7 * getSpellPower(spellLevel, caster);
    }
